                ...
                <ModalForm title='Add New Task' isVisible={showingModal}>
                    ...
                    peer-checked:text-secondary-content flex flex-row justify-items-end">
                        ...
                        <div className='pt-5 w-full flex flex-row gap-4'>
                            <button type='submit' data-testid="submitButton" className="btn btn-success btn-sm md:btn-md  w-1/2 flex flex-row" disabled={isPending}>
                        ...
                        <div className='text-sm md:text-base  flex flex-col pt-5'>
                            {typeof (status) === "string" ? status.toString()
                                ...
                                <div data-testid="errorsSection">{
                                    status.map(issue => <span key={issue.message} className='text-orange-300 text-left'>- {issue.message}</span>)
                                }
                                </div>
                            }
                        </div>
